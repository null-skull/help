...
export default function AnnouncementBar() {
  return (
    <Section className="tone-yellow relative overflow-hidden border-b px-gutter py-3.5">
      <div
        aria-hidden
        className="absolute left-1/2 top-1/2 h-[244px] w-[max(1400px,100%)] -translate-x-1/2 -translate-y-1/2 bg-repeat-x opacity-40"
      ...
      <Reveal as="div" className="relative flex items-center gap-2.5" selector="*" y={10}>
        <span className="shrink-0 whitespace-nowrap rounded-2xl bg-accent px-4 py-1.5 text-sm font-medium tracking-[0.42px] text-page">
          {ANNOUNCEMENT.badge}
        </span>
